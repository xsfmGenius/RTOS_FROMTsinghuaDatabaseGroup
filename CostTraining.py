        ...
        for t in count():
            ...
            if done:
                ...
                if ((i_episode + 1)%print_every==0):
                    ...
                    # print("train")
                    # train_value = DQN.validate(trainSet)
                    # print("validate")
                    ...
                    if val_value < best_val_value:
                        ...
                        torch.save(policy_net.cpu().state_dict(), 'bestCostTraining.pth')
